...
class mm_x4_x4_x4_graph0 : public adf::graph {
public:
    ...
    mm_k1_B4_L0 <17, 0>  mm_0_0;
    mm_k1_B4_L0 <20, 1>  mm_0_2;
    mm_k1_B4_L0 <17, 2>  mm_0_1;
    mm_k1_B4_L0 <20, 3>  mm_0_3;
    mm_k1_B4_L0 <21, 0>  mm_1_0;
    mm_k1_B4_L0 <24, 1>  mm_1_2;
    mm_k1_B4_L0 <21, 2>  mm_1_1;
    mm_k1_B4_L0 <24, 3>  mm_1_3;
    mm_k1_B4_L0 <25, 0>  mm_2_0;
    mm_k1_B4_L0 <28, 1>  mm_2_2;
    mm_k1_B4_L0 <25, 2>  mm_2_1;
    mm_k1_B4_L0 <28, 3>  mm_2_3;
    mm_k1_B4_L0 <29, 0>  mm_3_0;
    mm_k1_B4_L0 <32, 1>  mm_3_2;
    mm_k1_B4_L0 <29, 2>  mm_3_1;
    mm_k1_B4_L0 <32, 3>  mm_3_3;
    ...
    mm_x4_x4_x4_graph0 () {
        ...
        connect<window<L0_h1*L0_w2*L0_Byte>,pktstream>(mm_1_2.out,mg_out[1].in[2]);
        connect<window<L0_h1*L0_w2*L0_Byte>,pktstream>(mm_1_3.out,mg_out[1].in[3]);
        ...
        connect<window<L0_h1*L0_w2*L0_Byte>,pktstream>(mm_2_2.out,mg_out[2].in[2]);
        connect<window<L0_h1*L0_w2*L0_Byte>,pktstream>(mm_2_3.out,mg_out[2].in[3]);
        connect<window<L0_h1*L0_w2*L0_Byte>,pktstream>(mm_3_0.out,mg_out[3].in[0]);
        connect<window<L0_h1*L0_w2*L0_Byte>,pktstream>(mm_3_1.out,mg_out[3].in[1]);
        connect<window<L0_h1*L0_w2*L0_Byte>,pktstream>(mm_3_2.out,mg_out[3].in[2]);
        connect<window<L0_h1*L0_w2*L0_Byte>,pktstream>(mm_3_3.out,mg_out[3].in[3]);
