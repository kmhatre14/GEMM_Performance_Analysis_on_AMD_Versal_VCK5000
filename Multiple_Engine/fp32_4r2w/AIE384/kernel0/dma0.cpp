...
#pragma HLS ARRAY_PARTITION variable = buff1_C cyclic factor = BUFFC_FACTOR dim = 4
    ...
    for (int rd = 0; rd < Total_rd + 2; rd++)
    {
        ...
        if (rd % 2 == 0 && c_flg == 0)
        {
            ...
            sendB<6>(buff1_B[6], txB36, txB37, txB38, txB39, txB40, txB41, rd > 0 && rd < Total_rd + 1);
            sendB<7>(buff1_B[7], txB42, txB43, txB44, txB45, txB46, txB47, rd > 0 && rd < Total_rd + 1);
        ...
        else if (rd % 2 == 1 && c_flg == 0)
        {
            ...
            sendB<6>(buff0_B[6], txB36, txB37, txB38, txB39, txB40, txB41, rd > 0 && rd < Total_rd + 1);
            sendB<7>(buff0_B[7], txB42, txB43, txB44, txB45, txB46, txB47, rd > 0 && rd < Total_rd + 1);
