...
int main(int argc, char **argv)
{
    ...
    auto out_bohdl = xrt::bo(device, sizeOut * sizeof(float), dma0.group_id(0));
    ...
    for (int i = 0; i < iter; i++)
    {
        ...
        dma_run0 = dma0(in_bohdl0, in_bohdl2, in_bohdl1 ,in_bohdl3, out_bohdl,
    ...
    // sync output memory
    out_bohdl.sync(XCL_BO_SYNC_BO_FROM_DEVICE, sizeOut * sizeof(float), /*OFFSET=*/0);
