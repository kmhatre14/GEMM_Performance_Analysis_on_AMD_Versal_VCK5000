...
simulation::platform<8, 2> platform(
LHS_in0_L0,
LHS_in1_L0,
LHS_in2_L0,
LHS_in3_L0,
...
connect<> net_rhs_in0_L0 (platform.src[4], mm_graph0.in_rhs[0][0]);
connect<> net_rhs_in1_L0 (platform.src[5], mm_graph0.in_rhs[1][0]);
connect<> net_rhs_in2_L0 (platform.src[6], mm_graph0.in_rhs[2][0]);
connect<> net_rhs_in3_L0 (platform.src[7], mm_graph0.in_rhs[3][0]);
