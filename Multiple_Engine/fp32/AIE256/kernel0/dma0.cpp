...
void compute(axis_stream_A& dataA_out, axis_stream_B& dataB_out, axis_stream_C& dataC_in,
    ...
    for (int rd=0; rd<Total_rd+2;rd++){
        ...
        if(rd%2==0&&c_flg==0){
            ...
            sendB<0>(buff1_B[0],txB0,txB1,txB2,txB3,rd>0&&rd<Total_rd+1);
            sendB<1>(buff1_B[1],txB4,txB5,txB6,txB7,rd>0&&rd<Total_rd+1);
            sendB<2>(buff1_B[2],txB8,txB9,txB10,txB11,rd>0&&rd<Total_rd+1);
            sendB<3>(buff1_B[3],txB12,txB13,txB14,txB15,rd>0&&rd<Total_rd+1);
            sendB<4>(buff1_B[4],txB16,txB17,txB18,txB19,rd>0&&rd<Total_rd+1);
            sendB<5>(buff1_B[5],txB20,txB21,txB22,txB23,rd>0&&rd<Total_rd+1);
            sendB<6>(buff1_B[6],txB24,txB25,txB26,txB27,rd>0&&rd<Total_rd+1);
            sendB<7>(buff1_B[7],txB28,txB29,txB30,txB31,rd>0&&rd<Total_rd+1);
            ...
            sendB<0>(buff0_B[0],txB0,txB1,txB2,txB3,rd>0&&rd<Total_rd+1);
            sendB<1>(buff0_B[1],txB4,txB5,txB6,txB7,rd>0&&rd<Total_rd+1);
            sendB<2>(buff0_B[2],txB8,txB9,txB10,txB11,rd>0&&rd<Total_rd+1);
            sendB<3>(buff0_B[3],txB12,txB13,txB14,txB15,rd>0&&rd<Total_rd+1);
            sendB<4>(buff0_B[4],txB16,txB17,txB18,txB19,rd>0&&rd<Total_rd+1);
            sendB<5>(buff0_B[5],txB20,txB21,txB22,txB23,rd>0&&rd<Total_rd+1);
            sendB<6>(buff0_B[6],txB24,txB25,txB26,txB27,rd>0&&rd<Total_rd+1);
            sendB<7>(buff0_B[7],txB28,txB29,txB30,txB31,rd>0&&rd<Total_rd+1);
