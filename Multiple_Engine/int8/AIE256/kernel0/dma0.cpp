...
void compute(axis_stream_A& dataA_out, axis_stream_B& dataB_out, axis_stream_C& dataC_in,
    ...
    for (int rd=0; rd<Total_rd+2;rd++){
        ...
        if(rd%2==0&&c_flg==0){
            ...
            sendA<0>(buff1_A[0],txA0,txA4,rd>0&&rd<Total_rd+1);
            sendA<1>(buff1_A[1],txA1,txA5,rd>0&&rd<Total_rd+1);
            sendA<2>(buff1_A[2],txA2,txA6,rd>0&&rd<Total_rd+1);
            sendA<3>(buff1_A[3],txA3,txA7,rd>0&&rd<Total_rd+1);
            sendA<4>(buff1_A[4],txA8,txA12,rd>0&&rd<Total_rd+1);
            sendA<5>(buff1_A[5],txA9,txA13,rd>0&&rd<Total_rd+1);
            sendA<6>(buff1_A[6],txA10,txA14,rd>0&&rd<Total_rd+1);
            sendA<7>(buff1_A[7],txA11,txA15,rd>0&&rd<Total_rd+1);
            sendA<8>(buff1_A[8],txA16,txA20,rd>0&&rd<Total_rd+1);
            sendA<9>(buff1_A[9],txA17,txA21,rd>0&&rd<Total_rd+1);
            sendA<10>(buff1_A[10],txA18,txA22,rd>0&&rd<Total_rd+1);
            sendA<11>(buff1_A[11],txA19,txA23,rd>0&&rd<Total_rd+1);
            sendA<12>(buff1_A[12],txA24,txA28,rd>0&&rd<Total_rd+1);
            sendA<13>(buff1_A[13],txA25,txA29,rd>0&&rd<Total_rd+1);
            sendA<14>(buff1_A[14],txA26,txA30,rd>0&&rd<Total_rd+1);
            sendA<15>(buff1_A[15],txA27,txA31,rd>0&&rd<Total_rd+1);
            

            sendB<0>(buff1_B[0],txB0,txB4,rd>0&&rd<Total_rd+1);
            sendB<1>(buff1_B[1],txB1,txB5,rd>0&&rd<Total_rd+1);
            sendB<2>(buff1_B[2],txB2,txB6,rd>0&&rd<Total_rd+1);
            sendB<3>(buff1_B[3],txB3,txB7,rd>0&&rd<Total_rd+1);
            sendB<4>(buff1_B[4],txB8,txB12,rd>0&&rd<Total_rd+1);
            sendB<5>(buff1_B[5],txB9,txB13,rd>0&&rd<Total_rd+1);
            sendB<6>(buff1_B[6],txB10,txB14,rd>0&&rd<Total_rd+1);
            sendB<7>(buff1_B[7],txB11,txB15,rd>0&&rd<Total_rd+1);
            sendB<8>(buff1_B[8],txB16,txB20,rd>0&&rd<Total_rd+1);
            sendB<9>(buff1_B[9],txB17,txB21,rd>0&&rd<Total_rd+1);
            sendB<10>(buff1_B[10],txB18,txB22,rd>0&&rd<Total_rd+1);
            sendB<11>(buff1_B[11],txB19,txB23,rd>0&&rd<Total_rd+1);
            sendB<12>(buff1_B[12],txB24,txB28,rd>0&&rd<Total_rd+1);
            sendB<13>(buff1_B[13],txB25,txB29,rd>0&&rd<Total_rd+1);
            sendB<14>(buff1_B[14],txB26,txB30,rd>0&&rd<Total_rd+1);
            sendB<15>(buff1_B[15],txB27,txB31,rd>0&&rd<Total_rd+1);
            sendB<16>(buff1_B[16],txB32,txB36,rd>0&&rd<Total_rd+1);
            sendB<17>(buff1_B[17],txB33,txB37,rd>0&&rd<Total_rd+1);
            sendB<18>(buff1_B[18],txB34,txB38,rd>0&&rd<Total_rd+1);
            sendB<19>(buff1_B[19],txB35,txB39,rd>0&&rd<Total_rd+1);
            sendB<20>(buff1_B[20],txB40,txB44,rd>0&&rd<Total_rd+1);
            sendB<21>(buff1_B[21],txB41,txB45,rd>0&&rd<Total_rd+1);
            sendB<22>(buff1_B[22],txB42,txB46,rd>0&&rd<Total_rd+1);
            sendB<23>(buff1_B[23],txB43,txB47,rd>0&&rd<Total_rd+1);
            sendB<24>(buff1_B[24],txB48,txB52,rd>0&&rd<Total_rd+1);
            sendB<25>(buff1_B[25],txB49,txB53,rd>0&&rd<Total_rd+1);
            sendB<26>(buff1_B[26],txB50,txB54,rd>0&&rd<Total_rd+1);
            sendB<27>(buff1_B[27],txB51,txB55,rd>0&&rd<Total_rd+1);
            sendB<28>(buff1_B[28],txB56,txB60,rd>0&&rd<Total_rd+1);
            sendB<29>(buff1_B[29],txB57,txB61,rd>0&&rd<Total_rd+1);
            sendB<30>(buff1_B[30],txB58,txB62,rd>0&&rd<Total_rd+1);
            sendB<31>(buff1_B[31],txB59,txB63,rd>0&&rd<Total_rd+1);
            ...
            sendA<0>(buff0_A[0],txA0,txA4,rd>0&&rd<Total_rd+1);
            sendA<1>(buff0_A[1],txA1,txA5,rd>0&&rd<Total_rd+1);
            sendA<2>(buff0_A[2],txA2,txA6,rd>0&&rd<Total_rd+1);
            sendA<3>(buff0_A[3],txA3,txA7,rd>0&&rd<Total_rd+1);
            sendA<4>(buff0_A[4],txA8,txA12,rd>0&&rd<Total_rd+1);
            sendA<5>(buff0_A[5],txA9,txA13,rd>0&&rd<Total_rd+1);
            sendA<6>(buff0_A[6],txA10,txA14,rd>0&&rd<Total_rd+1);
            sendA<7>(buff0_A[7],txA11,txA15,rd>0&&rd<Total_rd+1);
            sendA<8>(buff0_A[8],txA16,txA20,rd>0&&rd<Total_rd+1);
            sendA<9>(buff0_A[9],txA17,txA21,rd>0&&rd<Total_rd+1);
            sendA<10>(buff0_A[10],txA18,txA22,rd>0&&rd<Total_rd+1);
            sendA<11>(buff0_A[11],txA19,txA23,rd>0&&rd<Total_rd+1);
            sendA<12>(buff0_A[12],txA24,txA28,rd>0&&rd<Total_rd+1);
            sendA<13>(buff0_A[13],txA25,txA29,rd>0&&rd<Total_rd+1);
            sendA<14>(buff0_A[14],txA26,txA30,rd>0&&rd<Total_rd+1);
            sendA<15>(buff0_A[15],txA27,txA31,rd>0&&rd<Total_rd+1);
            

            sendB<0>(buff0_B[0],txB0,txB4,rd>0&&rd<Total_rd+1);
            sendB<1>(buff0_B[1],txB1,txB5,rd>0&&rd<Total_rd+1);
            sendB<2>(buff0_B[2],txB2,txB6,rd>0&&rd<Total_rd+1);
            sendB<3>(buff0_B[3],txB3,txB7,rd>0&&rd<Total_rd+1);
            sendB<4>(buff0_B[4],txB8,txB12,rd>0&&rd<Total_rd+1);
            sendB<5>(buff0_B[5],txB9,txB13,rd>0&&rd<Total_rd+1);
            sendB<6>(buff0_B[6],txB10,txB14,rd>0&&rd<Total_rd+1);
            sendB<7>(buff0_B[7],txB11,txB15,rd>0&&rd<Total_rd+1);
            sendB<8>(buff0_B[8],txB16,txB20,rd>0&&rd<Total_rd+1);
            sendB<9>(buff0_B[9],txB17,txB21,rd>0&&rd<Total_rd+1);
            sendB<10>(buff0_B[10],txB18,txB22,rd>0&&rd<Total_rd+1);
            sendB<11>(buff0_B[11],txB19,txB23,rd>0&&rd<Total_rd+1);
            sendB<12>(buff0_B[12],txB24,txB28,rd>0&&rd<Total_rd+1);
            sendB<13>(buff0_B[13],txB25,txB29,rd>0&&rd<Total_rd+1);
            sendB<14>(buff0_B[14],txB26,txB30,rd>0&&rd<Total_rd+1);
            sendB<15>(buff0_B[15],txB27,txB31,rd>0&&rd<Total_rd+1);
            sendB<16>(buff0_B[16],txB32,txB36,rd>0&&rd<Total_rd+1);
            sendB<17>(buff0_B[17],txB33,txB37,rd>0&&rd<Total_rd+1);
            sendB<18>(buff0_B[18],txB34,txB38,rd>0&&rd<Total_rd+1);
            sendB<19>(buff0_B[19],txB35,txB39,rd>0&&rd<Total_rd+1);
            sendB<20>(buff0_B[20],txB40,txB44,rd>0&&rd<Total_rd+1);
            sendB<21>(buff0_B[21],txB41,txB45,rd>0&&rd<Total_rd+1);
            sendB<22>(buff0_B[22],txB42,txB46,rd>0&&rd<Total_rd+1);
            sendB<23>(buff0_B[23],txB43,txB47,rd>0&&rd<Total_rd+1);
            sendB<24>(buff0_B[24],txB48,txB52,rd>0&&rd<Total_rd+1);
            sendB<25>(buff0_B[25],txB49,txB53,rd>0&&rd<Total_rd+1);
            sendB<26>(buff0_B[26],txB50,txB54,rd>0&&rd<Total_rd+1);
            sendB<27>(buff0_B[27],txB51,txB55,rd>0&&rd<Total_rd+1);
            sendB<28>(buff0_B[28],txB56,txB60,rd>0&&rd<Total_rd+1);
            sendB<29>(buff0_B[29],txB57,txB61,rd>0&&rd<Total_rd+1);
            sendB<30>(buff0_B[30],txB58,txB62,rd>0&&rd<Total_rd+1);
            sendB<31>(buff0_B[31],txB59,txB63,rd>0&&rd<Total_rd+1);
