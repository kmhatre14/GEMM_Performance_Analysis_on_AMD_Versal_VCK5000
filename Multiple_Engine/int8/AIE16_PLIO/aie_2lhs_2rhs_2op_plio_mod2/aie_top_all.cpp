...
PLIO* LHS_in0_L0 = new PLIO("LHS_in0_L0", adf::plio_128_bits, "data/mod2/input0.txt",230);
PLIO* LHS_in1_L0 = new PLIO("LHS_in1_L0", adf::plio_128_bits, "data/mod2/input0.txt",230);

PLIO* RHS_in0_L0 = new PLIO("RHS_in0_L0", adf::plio_128_bits, "data/mod2/input1.txt",230);
PLIO* RHS_in1_L0 = new PLIO("RHS_in1_L0", adf::plio_128_bits, "data/mod2/input1.txt",230);
...
connect<> net_rhs_in0_L0 (platform.src[2], mm_graph0.in_rhs[0]);
connect<> net_rhs_in1_L0 (platform.src[3], mm_graph0.in_rhs[1]);
