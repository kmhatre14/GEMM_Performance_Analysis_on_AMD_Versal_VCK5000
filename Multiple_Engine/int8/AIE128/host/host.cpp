...
int main(int argc, char** argv) {
    ...
    auto out_bohdl = xrt::bo(device, sizeOut* sizeof(int8_t), dma0.group_id(0));
    ...
    // sync output memory
    out_bohdl.sync(XCL_BO_SYNC_BO_FROM_DEVICE , sizeOut* sizeof(int8_t),/*OFFSET=*/ 0);
