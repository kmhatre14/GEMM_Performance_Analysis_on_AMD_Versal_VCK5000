...
class mm_x4_x8_x4_graph0 : public adf::graph {
public:
    ...
    mm_k7_B8_L0 <16, 1>  mm_0_2;
    mm_k7_B8_L0 <9, 2>  mm_0_1;
    mm_k7_B8_L0 <16, 3>  mm_0_3;
    mm_k7_B8_L0 <17, 0>  mm_1_0;
    mm_k7_B8_L0 <24, 1>  mm_1_2;
    mm_k7_B8_L0 <17, 2>  mm_1_1;
    mm_k7_B8_L0 <24, 3>  mm_1_3;
    mm_k7_B8_L0 <25, 0>  mm_2_0;
    mm_k7_B8_L0 <32, 1>  mm_2_2;
    mm_k7_B8_L0 <25, 2>  mm_2_1;
    mm_k7_B8_L0 <32, 3>  mm_2_3;
    mm_k7_B8_L0 <33, 0>  mm_3_0;
    mm_k7_B8_L0 <40, 1>  mm_3_2;
    mm_k7_B8_L0 <33, 2>  mm_3_1;
    mm_k7_B8_L0 <40, 3>  mm_3_3;
    ...
    mm_x4_x8_x4_graph0 () {
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[1][2],mm_0_2.in0[2]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[1][3],mm_0_2.in0[3]);
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[1][2],mm_0_3.in0[2]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[1][3],mm_0_3.in0[3]);
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[3][2],mm_1_2.in0[2]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[3][3],mm_1_2.in0[3]);
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[3][2],mm_1_3.in0[2]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[3][3],mm_1_3.in0[3]);
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[5][2],mm_2_2.in0[2]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[5][3],mm_2_2.in0[3]);
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[5][2],mm_2_3.in0[2]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[5][3],mm_2_3.in0[3]);
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[7][2],mm_3_2.in0[2]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[7][3],mm_3_2.in0[3]);
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[7][2],mm_3_3.in0[2]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[7][3],mm_3_3.in0[3]);
