...
class mm_x2_x4_x4_graph0 : public adf::graph {
public:
    ...
    mm_k7_B4_L0 <24, 1>  mm_0_2;
    mm_k7_B4_L0 <21, 2>  mm_0_1;
    mm_k7_B4_L0 <24, 3>  mm_0_3;
    mm_k7_B4_L0 <25, 0>  mm_1_0;
    mm_k7_B4_L0 <28, 1>  mm_1_2;
    mm_k7_B4_L0 <25, 2>  mm_1_1;
    mm_k7_B4_L0 <28, 3>  mm_1_3;
    ...
    mm_x2_x4_x4_graph0 () {
        ...
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[1][1],mm_0_1.in1[1]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[1][0],mm_1_1.in1[0]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[1][1],mm_1_1.in1[1]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[2][0],mm_0_2.in1[0]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[2][1],mm_0_2.in1[1]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[2][0],mm_1_2.in1[0]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[2][1],mm_1_2.in1[1]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[3][0],mm_0_3.in1[0]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[3][1],mm_0_3.in1[1]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[3][0],mm_1_3.in1[0]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[3][1],mm_1_3.in1[1]);
