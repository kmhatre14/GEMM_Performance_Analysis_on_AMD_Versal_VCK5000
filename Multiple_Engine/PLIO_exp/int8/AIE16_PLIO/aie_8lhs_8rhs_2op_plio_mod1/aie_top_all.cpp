...
simulation::platform<16, 2> platform(
LHS_in0_L0,
LHS_in1_L0,
LHS_in2_L0,
LHS_in3_L0,
...
connect<> net_rhs_in4_L0 (platform.src[12], mm_graph0.in_rhs[2][0]);
connect<> net_rhs_in5_L0 (platform.src[13], mm_graph0.in_rhs[2][1]);
connect<> net_rhs_in6_L0 (platform.src[14], mm_graph0.in_rhs[3][0]);
connect<> net_rhs_in7_L0 (platform.src[15], mm_graph0.in_rhs[3][1]);
