...
public:
    ...
    mm_x2_x4_x2_graph0 () {
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[1][1],mm_0_1.in0[1]);
        ...
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[3][0],mm_1_1.in0[0]);
        connect<pktstream,window<L0_h1*L0_w1*L0_Byte>>(in_lhs[3][1],mm_1_1.in0[1]);
        ...
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[1][0],mm_1_0.in1[0]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[1][1],mm_1_0.in1[1]);
        ...
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[3][0],mm_1_1.in1[0]);
        connect<pktstream,window<L0_w1*L0_w2*L0_Byte>>(in_rhs[3][1],mm_1_1.in1[1]);
