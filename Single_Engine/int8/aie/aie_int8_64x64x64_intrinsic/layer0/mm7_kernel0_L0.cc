...
void mm7_kernel0_L0(input_window_int8* __restrict matA, 
    ...
    // aie::vector<int8,32> temp = window_read_v32(matA);
    ...
    chess_loop_range(L0_boundary_i,)
    {
        ...
        chess_loop_range(L0_boundary_j,)
        {
            ...
            for (int k=0;k<L0_boundary_k;k++)
            chess_prepare_for_pipelining
            chess_unroll_loop(L0_boundary_k)
            {
                // aie::print(temp,true,"temp=");
				// aie::print(tempbuf_matA,true,"tempbuf_matA=");
                //K iteration 0
