...
public:
    ...
    mm_x1_x2_x2_graph0 () {
      ...
      connect<window<L0_h1*L0_w1*L0_Byte>>(in_lhs[0], mm[0].in[0]);
      connect<window<L0_w1*L0_w2*L0_Byte>>(in_rhs[0], mm[0].in[1]);

      connect<window<L0_h1*L0_w2*L0_Byte>>(mm[0].out[0], out[0]);
