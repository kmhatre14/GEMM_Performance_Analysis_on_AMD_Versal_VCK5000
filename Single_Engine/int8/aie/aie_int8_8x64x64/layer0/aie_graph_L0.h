...
class mm_k7_B2_L0: public graph {
  private:
    kernel mm[1];
  ...
  public:
    ...
    mm_k7_B2_L0() {
      ...
      //   if(i==0){
      //     mm[i] = kernel::create(mm7_kernel0_L0);
      //     source(mm[i]) = "mm7_kernel0_L0.cc";
      //   }
      //   else if(i==L0_NUM_KERNEL-1){
      //     mm[i] = kernel::create(mm7_kernel2_L0);
      //     source(mm[i]) = "mm7_kernel2_L0.cc";
      //   }
      ...
      //   }
      // }
      mm[0] = kernel::create(mm7_kernel0_L0);
      source(mm[0]) = "mm7_kernel0_L0.cc";  
